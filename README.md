...
Prebuilt binaries for Linux (amd64, arm64), macOS (amd64, arm64), Windows (amd64), OpenBSD (amd64), and FreeBSD (amd64) are on the [releases page](https://github.com/farrokhi/localzone-leaktest/releases). Or build from a checkout with `go build -o localzone-leaktest .`; requires Go 1.25 or newer. The binary has no runtime dependencies.
